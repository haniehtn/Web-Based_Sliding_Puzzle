...
<%
    ...
    String[][] Colors5= (String[][]) request.getSession().getAttribute("Colors");
...
<form action="level5" method="post">
    <TABLE name="begin"  width="210" height="210" border="0">
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors5[0][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[0][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[0][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[0][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[0][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors5[1][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[1][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[1][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[1][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[1][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors5[2][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[2][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[2][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[2][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[2][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors5[3][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[3][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[3][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[3][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[3][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors5[4][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[4][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[4][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[4][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors5[4][4]%>></TD>
       ...
       <input type="submit" name="s30" value="Restart"><br/>
    ...
    <TABLE name="end"  width="210" height="210" border="0"> <TR height="30" >
        <TD width="30" ></TD></TR>
        <TR height="30" >
            <TD width="30" ></TD> <TD width="30" bgcolor="lime"></TD>
