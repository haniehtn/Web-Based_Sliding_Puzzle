...
<%
    ...
    String[][] Colors3= (String[][]) request.getSession().getAttribute("Colors");
...
<form action="level3" method="post">
    <TABLE name="begin"  width="210" height="210" border="0">
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors3[0][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[0][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[0][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[0][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[0][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors3[1][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[1][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[1][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[1][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[1][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors3[2][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[2][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[2][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[2][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[2][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors3[3][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[3][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[3][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[3][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[3][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors3[4][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[4][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[4][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[4][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors3[4][4]%>></TD>
    ...
    <input type="submit" name="s26" value="Restart"><br/>
...
<TABLE name="end" width="210" height="210" border="0">
    <TR height="30" ><TD width="30" ></TD></TR>
    ...
    <TR height="30" >
        ...
        <TD width="30" ></TD> </TR>
    <TR height="30" >
        <TD width="30" ></TD> <TD width="30" bgcolor="purple"></TD>
        <TD width="30" bgcolor="orange"></TD>
        <TD width="30" bgcolor="purple"></TD>
        <TD width="30" bgcolor="orange"></TD>
        <TD width="30" bgcolor="purple"></TD>
