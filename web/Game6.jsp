...
<%
    ...
    String[][] Colors6= (String[][]) request.getSession().getAttribute("Colors");
...
<form action="level6" method="post">
    <TABLE name="begin"  width="210" height="210" border="0">
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors6[0][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[0][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[0][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[0][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[0][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors6[1][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[1][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[1][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[1][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[1][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors6[2][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[2][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[2][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[2][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[2][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors6[3][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[3][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[3][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[3][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[3][4]%>></TD>
        ...
        <TR height="30" >
            ...
            <TD width="30" bgcolor=<%= Colors6[4][0]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[4][1]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[4][2]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[4][3]%>></TD>
            <TD width="30" bgcolor=<%= Colors6[4][4]%>></TD>
      ...
      <input type="submit" name="s32" value="Restart"><br/>
       <%=(String)(request.getAttribute("error")!=null?request.getAttribute("error"):"")%><br/>
       <%=(String)(request.getAttribute("move")!=null?request.getAttribute("move"):"")%><br/>
      <%=(String)(request.getAttribute("time")!=null?request.getAttribute("time"):"")%><br/>
...
<TABLE name="end"  width="210" height="210" border="0"> <TR height="30" >
        ...
        <TR height="30" >
            ...
            <TD width="30" ></TD> </TR>
        <TR height="30" >
            <TD width="30" ></TD> <TD width="30" bgcolor="orange"></TD>
            <TD width="30" bgcolor="lime"></TD>
            <TD width="30" bgcolor="orange"></TD>
            <TD width="30" bgcolor="lime"></TD>
            <TD width="30" bgcolor="orange"></TD>
            <TD width="30" ></TD> </TR>
